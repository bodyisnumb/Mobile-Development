...
import com.example.SevaLab.dnldrtask.model.Datum;
import com.example.SevaLab.dnldrtask.model.Image;
import com.example.SevaLab.dnldrtask.model.ImageRepo;
import com.example.SevaLab.dnldrtask.model.ImgurService;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            restInterface.getAllImages(new retrofit.Callback<Image>() {
                ...
                public void success(Image model, retrofit.client.Response response) {
                    ...
                    //This is used because the older version of android can't support java 8 APIs
