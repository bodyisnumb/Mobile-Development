...
package com.seva.lab78.artist.view;
...
import com.seva.lab78.data.api.client.SpotifyClient;
import com.seva.lab78.track.view.TracksActivity;
...
import com.seva.lab78.R;

public class ArtistsFragment extends Fragment
    implements com.seva.lab78.artist.ArtistContract.View, SearchView.OnQueryTextListener {
  ...
  private com.seva.lab78.artist.ArtistsPresenter artistsPresenter;
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    artistsPresenter = new com.seva.lab78.artist.ArtistsPresenter(new com.seva.lab78.artist.ArtistsInteractor(new SpotifyClient()));
  ...
  @Override
  public void renderArtists(List<com.seva.lab78.artist.model.Artist> artists) {
  ...
  public void setupRecyclerView() {
    ...
    adapter.setItemClickListener(
        (com.seva.lab78.artist.model.Artist artist, int position) -> artistsPresenter
            .launchArtistDetail(getContext(),artist));
    artist_recyclerView.setAdapter(adapter);
  }

  @Override
  public Intent getStartIntent(Context context, com.seva.lab78.artist.Artist artist) {
