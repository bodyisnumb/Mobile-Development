...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ArtistsViewHolder> {
  ...
  private List<com.seva.lab78.artist.model.Artist> artists = Collections.emptyList();
  ...
  public void onBindViewHolder(@NonNull ArtistsViewHolder holder, int position) {
    com.seva.lab78.artist.model.Artist artist = artists.get(position);
  ...
  void setArtists(List<com.seva.lab78.artist.model.Artist> artists) {
  ...
  public interface ItemClickListener {
    void onItemClick(com.seva.lab78.artist.model.Artist artist, int position);
  }
  ...
  static class ArtistsViewHolder extends RecyclerView.ViewHolder {
    ...
    com.seva.lab78.artist.model.Artist artist;
    View itemView;
