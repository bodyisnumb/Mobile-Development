...
public abstract class SpotifyRetrofitClient {
  ...
  private Gson getSpotifyDeserializer() {
    return new GsonBuilder().registerTypeAdapter(new com.google.gson.reflect.TypeToken<java.util.List<com.seva.lab78.artist.model.Artist>>() {
    }.getType(), new com.seva.lab78.data.api.retrofit.deserializer.ArtistsDeserializer<com.seva.lab78.artist.model.Artist>())
        .registerTypeAdapter(new com.google.gson.reflect.TypeToken<java.util.List<Track>>() {
        }.getType(), new com.seva.lab78.data.api.retrofit.deserializer.TracksDeserializer<Track>())
        .create();
  }
